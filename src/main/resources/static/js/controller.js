var pnpApp = angular.module("PicknPayWebApp.controllers", []).controller("PicknPayWebAppCtrl", function ($scope, $rootScope, $location, PostToServerService, UserGetService, ProductGetService) {
...
//-----------------------------------------------Function for manipulating customer details---------------------- 
    $scope.updateUser = function () {
        ...
        if (sessionStorage.getItem("sessionID") !== null && sessionStorage.getItem("userIn") !== null) {
            ...
            PostToServerService.sendToSever(requestData, "/TAKEALOT/updateProfile").then(function (response) {
...
//                        var sessionID = response.data.sessionID;               
    ...
    $scope.logout = function (url) {
        ...
        UserGetService.sendGetRequest("/TAKEALOT"+url+ "/" + sessionStorage.getItem("sessionID")).then(function (response) {
...
//-------------------------------------------Admin operations controller-----------------------------
 ...
 TAKE_A_LOT_APP.controller("AdminCtrl", function ($scope,$location, PostToServerService, UserGetService, ProductGetService) {
     
     $scope.addNewProduct = function(){
         
        var user = sessionStorage.getItem("userIn");
...
//--------------------------------------------App Services------------------------------------------
pnpApp.factory("PostToServerService", ["$http", function ($http) {
...
pnpApp.factory("UserGetService", ["$http", function ($http) {
...
pnpApp.factory("OrderPostService", ["$http", function ($http) {
...
pnpApp.factory("ProductGetService", ["$http", function ($http) {
